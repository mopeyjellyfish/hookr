...
func (c Config) Validate() error {
	...
	if !isSupportedLang(c.Lang) {
		return errors.New("hookr gen currently supports only --lang go, --lang rust, --lang zig, --lang cpp, --lang assemblyscript, --lang c, --lang swift, or --lang js")
	}
...
func ParseFlags(binaryName string, args []string) (Config, error) {
	...
	fs.StringVar(&cfg.Lang, "lang", cfg.Lang, "target language to generate (go, rust, zig, cpp, assemblyscript, c, swift, or js)")
...
func isSupportedLang(lang string) bool {
	...
	case "go", "rust", "zig", "cpp", "c++", "assemblyscript", "as", "c", "swift", "js", "javascript", "ts", "typescript", "javy":
		return true
	default:
		return false
	}
